...
private static final long serialVersionUID = 8743183987805808152L;
	...
	private int loops;
	// private List<Integer> ackTaskList;
	...
	public StatefulBolt(int changeTrafficFactor) {
	...
	public void prepare(@SuppressWarnings("rawtypes") Map stormConf, TopologyContext context, OutputCollector collector) {
		...
		try {
			processingTimeManager = new ProcessingTimeManager("stateful", context.getThisTaskId(), stormConf, context);
		} catch (Exception e) {
